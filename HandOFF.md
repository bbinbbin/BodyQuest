...
> 마지막 업데이트: 2026-04-08 (Phase 52 완료: 운동 GIF 전체 46개 적용 완성)
...
- **코어 5/5** ✅: 플랭크, 크런치, 레그레이즈, 바이시클 크런치, 행잉 레그레이즈
- **ENDURANCE 8/8** ✅: 가볍게 달리기, 인터벌, 장거리, 회복 조깅, 사이클링, 줄넘기 3종
- **BALANCE 9/9** ✅: 요가 3종, 스트레칭 3종, 필라테스 3종
...
- [x] 운동 GIF 이미지 시스템 — Coil GIF 디코더 + ExerciseImages 매핑 + 전체 46/46개 적용 완성
...
0d67de1 feat: 운동 GIF 4개 추가 — 등(데드리프트, 시티드 로우) + 하체(스쿼트, 레그프레스)
22e96dc feat: 운동 GIF 이미지 시스템 구축 — Coil GIF 디코더 + 8개 운동 GIF 적용
